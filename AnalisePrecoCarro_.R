...
dados <- data.frame(price = c(13495, 16500, 16500, 13950, 17450, 15250, 
           ...
           16515, 18420, 18950, 16845, 19045, 21485, 22470, 22625), length = c(168.8, 
           168.8, 171.2, 176.6, 176.6, 177.3, 192.7, 192.7, 192.7, 176.8, 
           ...
           188.8, 188.8, 188.8, 188.8), width = c(64.1, 64.1, 65.5, 66.2, 
    66.4, 66.3, 71.4, 71.4, 71.4, 64.8, 64.8, 64.8, 64.8, 66.9, 66.9, 
      ...
      67.2, 67.2, 68.9, 68.8, 68.9, 68.9, 68.9), height = c(48.8, 48.8, 
52.4, 54.3, 54.3, 53.1, 55.7, 55.7, 55.9, 54.3, 54.3, 54.3, 54.3, 
55.7, 55.7, 53.7, 56.3, 53.2, 52, 52, 50.8, 50.8, 50.8, 50.6, 
...
57.5, 56.2, 57.5, 56.2, 57.5, 55.5, 55.5, 55.5, 55.5, 55.5), 
  `curb-weight` = c(2548, 2548, 2823, 2337, 2824, 2507, 2844, 
                    ...
                    3049, 3012, 3217, 3062), `engine-size` = c(130, 130, 152, 
       ...
       141, 141, 141, 130, 130, 141, 141, 173, 145, 141), `city-mpg` = c(21, 
       21, 19, 24, 18, 19, 19, 19, 17, 23, 23, 21, 21, 20, 16, 16, 
                   ...
                   27, 27, 37, 26, 24, 24, 19, 33, 25, 23, 23, 24, 24, 17, 17, 
                   23, 19, 18, 26, 19), `highway-mpg` = c(27, 27, 26, 30, 22, 
                  25, 25, 25, 20, 29, 29, 28, 28, 25, 22, 22, 20, 53, 43, 43, 
                  ...
                  25), `fuel-type` = c("gas", "gas", "gas", "gas", "gas", "gas", 
...
"gas"), aspiration = c("std", "std", "std", "std", "std", 
...
"sedan", "sedan", "sedan", "sedan"), `drive-wheels` = c("rwd", 
...
#Investigação da relação do tipo de combustivel com a variavel possui turbo
...
plot(y = dados$Preco,
     x = dados$Peso,
     pch = 16) 
abline(lm(dados$Preco ~ dados$Peso), lwd = '3', col = 'red')
